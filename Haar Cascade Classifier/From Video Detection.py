...
face_cascade = cv2.CascadeClassifier(r"D:\Deep Learning\open cv -- practicle\Haarcascades\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier(r"D:\Deep Learning\open cv -- practicle\Haarcascades\haarcascade_eye.xml")
