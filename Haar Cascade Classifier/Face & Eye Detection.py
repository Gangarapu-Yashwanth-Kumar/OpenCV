...
face_classifier = cv2.CascadeClassifier(r"E:\haarcascade_frontalface_default.xml")
eye_classifier = cv2.CascadeClassifier(r"E:\haarcascade_eye.xml")

# Load the image
img = cv2.imread(r"D:\Happy Images\1.jpeg")
